...
- **Search (highlight-on-map)** *(targeted for launch, nice-to-have)* — filter `nodes` by name, fade non-matches (reuses the sector-hover opacity pattern). LAUNCH_CHECKLIST.md §4b.
